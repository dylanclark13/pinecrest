...
const TUTORIAL=[
 ...
 {chapter:'Getting started',title:'Choose your challenge',copy:'All four courses have 18 holes. Choose front nine, back nine, or a full round. Willow Park has wider fairways and slower greens; Pinecrest adds tighter lines, Granite Highlands adds elevation, and Atlantic Links has strong wind and fast greens.',cue:'RELAXED → CLUB → TOUR → CHAMPIONSHIP',tip:'Create your look in My golfer. Start with nine holes while learning.',question:'Which course gives you the most forgiving first round?',options:['Atlantic Links','Willow Park','Granite Highlands'],answer:1,feedback:'Willow Park offers the widest timing window and more forgiving conditions.'},
